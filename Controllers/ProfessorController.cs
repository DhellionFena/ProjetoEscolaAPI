    ...
    public class ProfessorController : ControllerBase
    {
        ...
        public async Task<IActionResult> put(int profId, Professor model) {
             try
            {
                ...
                if (professor == null) return NotFound("Professor n�o encontrado.");
                if (professor.id != model.id) throw new Exception("Id de professor n�o corresponde ao que ser� atualizado.");
                _repo.Update(model);
