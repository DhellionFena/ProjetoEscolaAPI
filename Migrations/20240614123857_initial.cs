    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Lauro", "André" });

            migrationBuilder.InsertData(
                table: "Professores",
                columns: new[] { "id", "nome", "sobrenome" },
                values: new object[] { 2, "Roberto", "Mendonça" });

            migrationBuilder.InsertData(
                table: "Professores",
                columns: new[] { "id", "nome", "sobrenome" },
                values: new object[] { 3, "Rodolfo", "Exler" });

            migrationBuilder.InsertData(
                table: "Professores",
                columns: new[] { "id", "nome", "sobrenome" },
                values: new object[] { 4, "Victor", "Winitskowski" });

            migrationBuilder.InsertData(
                table: "Professores",
                columns: new[] { "id", "nome", "sobrenome" },
                values: new object[] { 5, "Carlos", "Mattos" });
